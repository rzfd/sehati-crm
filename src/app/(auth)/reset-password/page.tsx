  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-4">
        ...
        <div>
          <h1 className="text-headline-sm text-ink">Reset password</h1>
          <p className="text-sm text-ink-muted">Buat password baru.</p>
        </div>
        ...
        {success ? (
          ...
          <form onSubmit={submit} className="space-y-3">
            <div>
              <label className="block text-xs text-ink-muted mb-1">Password baru</label>
              <input
            ...
            <div>
              <label className="block text-xs text-ink-muted mb-1">Konfirmasi password</label>
              <input
                type="password" required minLength={8}
